...
public class Mypanel{
    ...
    //DISABLING BUTTONS
    private void disableSortingButtons() {
    ...
    public void decendingOrderAlgoButtons(){
        insertionDec = new JButton("INSERTION SORT (DESCENDING)");
        ...
        bubbleDec = new JButton("BUBBLE SORT (DESCENDING)");
        ...
        mergeDec = new JButton("MERGE SORT (DESCENDING)");
        ...
        quickDec = new JButton("QUICK SORT (DESCENDING)");
        ...
        selectionDec = new JButton("SELECTION SORT (DESCENDING)");
        ...
        shellDec = new JButton("SHELL SORT (DESCENDING)");
